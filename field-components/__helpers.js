import { VueHelpers, Helpers } from 'toolpic';

const Compress = VueHelpers.compress;
const imageInfo = VueHelpers.imageInfo;
const blobToDataURL = Helpers.blobToDataURL;
