...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1200 1200">
    ...
    <g class="main" clip-path="url(#bounding)">
      ...
      <image v-scaleimage="pos" v-bind:xlink:href="image[0]" x="0" y="0" height="1200" width="1200" ref="testElement1" />
      ...
      <g v-dynamic data-dynamic-origin="none" data-dynamic-width="1050" data-dynamic-height="400" style="transform-origin: 50px 525px; text-shadow: 0px 0px 10px rgba(0, 0, 0, 0.7);">
        ...
        <g>
          <g v-for="(line, index) in title.filter(line => line)">
            <text x="50" v-bind:y="720 + index * 115" style="font-family: 'Jost-700'; font-size: 105px; fill: #fff;">
              {{ line }}
            </text>
          </g>
        </g>
      ...
      <image v-bind:xlink:href="logo" x="25" y="925" height="250" width="250" filter="url(#dropshadow)" />
