<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1080" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <g class="main" clip-path="url(#bounding)">
      ...
      <Dynamic width="900" height="800" origin="0.5 0.5">
        <MultiLine x="540" y="500" relative="0.5 0.5" padding="0" v-bind:text="fact" align="center" lineheight="1.1" background="none" css="font-size: 80px; font-weight: 800; font-family: 'Jost'; fill: #fff;"></MultiLine>
      </Dynamic>
  ...
  export default {
    ...
    data() {
      return {
        ...
        gradientMap: false,
        fact: [
          'DESCH IS JETZTE A GANZ',
          'SCHÖ WISCHTIG INFO.',
          'BIDDE ALL MA GUT LAUSCHE,',
          'SONST SIN MER ALL BÖS\'!'
        ],
        slidePos: 1,
