...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1200 1200" version="1.1">
    ...
    <g clip-path="url(#bounding)">
      ...
      <image v-scaleimage="pos" v-bind:xlink:href="image[0]" x="0" y="0" height="1200" width="1200" v-bind:filter="blackAndWhite ? 'url(#sw)' : ''" />

      <g v-dynamic data-dynamic-origin="none" data-dynamic-width="1140" data-dynamic-height="900">
        <MultiLine style="transform-origin: 30px 40px;" x="30" y="40" padding="10 15" v-bind:text="textToMultilineFormat(text.join(' '), 0.8, 0.3, true)" lineheight="1.1" background="#1DA64A" verticalalign="" css="font-size: 52px; font-family: 'Jost-400'; fill: #fff;"></MultiLine>
      </g>
      ...
      <image v-bind:xlink:href="logo" x="25" y="995" height="180" width="180" filter="url(#dropshadow)" />
  ...
  export default {
    ...
    data() {
      return {
        ...
        logo: 'https://cdn.fridaysforfuture.io/toolpic/assets/logo-og.svg'
      }
    }
  }
